...
class AliasStandaloneTranslationPublishPlugin(HookBaseClass):
    ...
    def __init__(self, *args, **kwargs):
        super(AliasStandaloneTranslationPublishPlugin, self).__init__(*args, **kwargs)
        self.__alias_api = None
    
    def get_alias_api(self, item):
        if self.__alias_api:
            return self.__alias_api
        alias_api = item.get_property("alias_api")
        if alias_api:
    ...
    def settings(self):
        ...
        base_settings = super(AliasStandaloneTranslationPublishPlugin, self).settings or {}
    ...
    def accept(self, settings, item):
        ...
        alias_api = self.get_alias_api(item)
    ...
    def validate(self, settings, item):
        ...
        return super(AliasStandaloneTranslationPublishPlugin, self).validate(settings, item)
    ...
    def _session_path(self, item=None):
        """
